...
├── Source/
│   ├── PluginProcessor.h        # Main audio processor (APVTS, oversampling, DSP)
│   ├── PluginProcessor.cpp
│   ├── PluginEditor.h           # GUI (Phase A layout + GrainColours)
│   ├── PluginEditor.cpp
...
├── Builds/
│   ├── MacOSX/                  # Generated by Projucer (plugin)
│   └── MacOSX-Tests/            # Generated by Projucer (tests)
...
|------|---------|--------------|
| **pluginval** | Plugin validation | [Download](https://github.com/Tracktion/pluginval) to `/Applications/pluginval.app` |
